...
* RTC (Built-in RTC)
* Nextion Editor
* USB-to-TTL Converter (for uploading TFT files)
* Personal Computer / Laptop
...
<p align="center">
  <img src="clock_loading.png" width="850">
</p>
...
| --------------------------------------- | ------------------------------------- |
| ![Selection Light](selection_light.png) | ![Selection Dark](selection_dark.png) |
...
| Light Theme                       | Dark Theme                      |
| --------------------------------- | ------------------------------- |
| ![Analog Light](analog_light.png) | ![Analog Dark](analog_dark.png) |
...
| Light Theme                       | Dark Theme                        |
| --------------------------------- | --------------------------------- |
| ![Digital Light](digit_light.png) | ![Digital Dark](digital_dark.png) |
